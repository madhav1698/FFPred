# -*- coding: utf-8 -*-
"""
Created on Sun Aug 30 18:39:20 2020
...
data_train=pd.read_excel(r"datasets_140442_330428_Data_Train.xlsx")
...
data_train.drop(data_train.loc[data_train["Airline"]=="Jet Airways"].index, inplace=True) #suspended airline
data_train.drop(data_train.loc[data_train["Airline"]=="Jet Airways Business"].index, inplace=True)
...
test_data.drop(test_data.loc[test_data["Airline"]=="Jet Airways"].index, inplace=True) #suspended airline
test_data.drop(test_data.loc[test_data["Airline"]=="Jet Airways Business"].index, inplace=True)
